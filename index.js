    ...
    map = new atlas.Map('myMap', {
        ...
        view: 'Auto',
                ...
                authOptions: {
                    ...
                    subscriptionKey: 'izgAMDT7BstYKc0RItqW9-RhZyhTh5R-JbR6s9HL0wg'
                }
    });
        ...
        .then(function (text) {
            ...
            for (i = 1; i < lines.length; i++) {
                ...
                if (row.length >= numColumns) {
                    ...
                    features.push(new atlas.data.Feature(new atlas.data.Point([parseFloat(row[header['longitudePhysical']]), parseFloat(row[header['latitudePhysical']])]), {
                        StoreName: row[header['storeName']],
                        AddressLine: row[header['line1AddressPhysical']],
                        City: row[header['cityNamePhysical']],
                        State: row[header['countrySubdivisionCodePhysical']],
                        Country: row[header['countryCodePhysical']],
                        PostalCode: row[header['postalCodePhysical']],
                        Phone: row[header['storePhoneNumber']],
                        StoreType: row[header['layoutName']],
                        IsDriveThru: (row[header['driveThruType']].toLowerCase() === 'Y') ? true : false,
                        IsWheelchairAccessible: (row[header['IsWheelchairAccessible']].toLowerCase() === 'true') ? true : false,
                        DateOpen: row[header['openDate']]
...
function showPopup(shape) {
    ...
    html.push('<div class="popupTitle">',
        ...
        '<br/>', distance,
        ' miles away',
        '<br /><img src="C:/Users/swdeshmu/Documents/Personal Docs/HACK/Starbucks-World-Map/images/PhoneIcon.png" title="Phone Icon"/><a href="tel:',
        properties['Phone'],
        '">', 
        properties['Phone'],
        '</a>'
